...
@FeignClient(url = "${AUDITCHECKLIST_SERVICE:http://localhost:8200}", name="auditChecklist")
public interface AuditCheckListFeign {
	
	@RequestMapping(value = "/api/checklist/audit-checklist-questions", method = RequestMethod.POST )
