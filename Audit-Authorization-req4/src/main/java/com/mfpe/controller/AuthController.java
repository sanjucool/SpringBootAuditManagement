...
import com.mfpe.model.AuthResponse;
...
public class AuthController {
	...
	public ResponseEntity<?> generateJwt(@Valid @RequestBody AuthenticationRequest request) {
		...
		try {
			...
			final String jwt = jwtService.generateToken(projectManagerDetails); // returning the token as response
			 ...
			 authResponse.setName(projectManagerDetails.getName());
			// test
			...
			response = new ResponseEntity<>(authResponse, HttpStatus.FORBIDDEN);
		}
